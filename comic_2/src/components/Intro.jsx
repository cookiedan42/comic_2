...
export default function Intro() {
    return (
        < div class="areaDiv" style={{ flexDirection: "row" }} >
            ...
            <p>
            View each section in order from 1 to 5
            </p>
            <p>
                Sections 2,3 and 4 are interactive and you move yourself through the story.
                Section 5 is a "movie" where the pace has been decided
            </p>
